...
use crate::v2::bottom_pane::BottomPane;
use crate::v2::bottom_pane::BottomPaneParams;
use crate::v2::bottom_pane::InputResult;
use crate::v2::bottom_pane::LocalImageAttachment;
use crate::v2::bottom_pane::MentionBinding;
use crate::v2::bottom_pane::ModelPickerEntry;
use crate::v2::exec_cell::truncated_tool_output_preview;
use crate::v2::history_cell;
use crate::v2::history_cell::HistoryCell;
use crate::v2::history_cell::PlainHistoryCell;
use crate::v2::markdown::append_markdown;
...
impl ChatWidget {
    ...
    fn handle_slash_command(&mut self, command: SlashCommand, argument: String) {
        match command {
            SlashCommand::Exit => {
                self.app_event_tx.send(AppEvent::Exit(
                    crate::v2::app_event::ExitMode::ShutdownFirst,
                ));
            }
            SlashCommand::Clear => {
                self.history.clear();
